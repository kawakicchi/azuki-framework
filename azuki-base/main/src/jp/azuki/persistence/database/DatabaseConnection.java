...
public final class DatabaseConnection {
	 ...
	 * @throws SQLException SQL例外が発生した場合
	 */
	public Connection getConnection(final boolean pool) throws SQLException {
		Connection con = null;
		if (pool) {
	 ...
	 * @throws SQLException SQL例外が発生した場合
	 */
	public void returnConnection(final Connection connection, final boolean pool) throws SQLException {
		if (null != connection) {
			if (pool) {
				connection.close();
			} else {
